    ...
    <main className="w-full min-h-screen flex overflow-y-hidden">
      ...
      <div className="flex-1 relative flex items-center justify-center min-h-full">
        ...
        <div className="w-full max-w-md md:max-w-lg space-y-8 px-4  text-gray-600 sm:px-0 z-20">
          <div className="relative">
            ...
            <div className="mt-5 space-y-2">
              <h3 className="text-gray-200 text-3xl  font-semibold tracking-tighter sm:text-4xl">
                Sign up - Start journey with Vibe Visison
              </h3>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5 z-20">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  required
                  className="w-full  px-3 py-5 text-gray-500 bg-transparent outline-none border focus:border-purple-600 shadow-sm rounded-lg"
                  placeholder="John"
                />
            ...
            <div className="relative">
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  className="w-full  px-3 py-5 text-gray-500 bg-transparent outline-none border focus:border-purple-600 shadow-sm rounded-lg pr-10"
