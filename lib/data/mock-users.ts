...
export const MOCK_USERS: Record<string, User> = {
  ...
  janedoe: {
    ...
    banner:
      "https://images.unsplash.com/photo-1558591710-4b4a1ae0f04d?w=1920&h=400&fit=crop",
    ...
    achievements: [
      { id: "1", name: "First Post", description: "Made your first post" },
      {
        id: "4",
        name: "Design Star",
        description: "Created a trending design post",
      },
    ],
  },
  techguru: {
    ...
    banner:
      "https://images.unsplash.com/photo-1579546929662-711aa81148cf?w=1920&h=400&fit=crop",
    ...
    achievements: [
      { id: "1", name: "First Post", description: "Made your first post" },
      {
        id: "5",
        name: "Tech Expert",
        description: "Contributed valuable tech insights",
      },
    ],
  },
};
